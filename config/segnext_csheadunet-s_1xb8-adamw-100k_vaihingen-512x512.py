...
data_root = 'D:/bubaiwork/Data/Vaihingen/Vaihingen512512'
crop_size = (512, 512)
train_pipeline = [
...
test_evaluator = dict(
    type='IoUMetric', iou_metrics=['mIoU', 'mDice', 'mFscore'])
checkpoint_file = 'pretrain/segnext/mscan_s_20230227-f33ccdf2.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='pretrain/segnext/mscan_s_20230227-f33ccdf2.pth'),
...
norm_cfg = dict(type='SyncBN', requires_grad=True)
launcher = 'none'
work_dir = './work_dirs\\segnext_csheadunet-s_1xb4-adamw-100k_vaihingen-512x512'
